...
is($source_yui_host->uri("imagecropper"), "http://yui.yahooapis.com/2.5.1/build/imagecropper/imagecropper.js");
is($source_yui_host->uri([qw/imagecropper min/]), "http://yui.yahooapis.com/2.5.1/build/imagecropper/imagecropper-min.js");
