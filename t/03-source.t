...
is($source_yui_host->uri("imagecropper"), "http://yui.yahooapis.com/2.8.1/build/imagecropper/imagecropper-beta.js");
is($source_yui_host->uri([qw/imagecropper min/]), "http://yui.yahooapis.com/2.8.1/build/imagecropper/imagecropper-beta-min.js");
